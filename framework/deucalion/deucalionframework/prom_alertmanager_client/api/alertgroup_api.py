...
class AlertgroupApi(object):
    ...
    def get_alert_groups(self, **kwargs):  # noqa: E501
        """get_alert_groups  # noqa: E501

        Get a list of alert groups  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_alert_groups(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_alert_groups_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_alert_groups_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_alert_groups_with_http_info(self, **kwargs):  # noqa: E501
        """get_alert_groups  # noqa: E501

        Get a list of alert groups  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_alert_groups_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['active', 'silenced', 'inhibited', 'filter', 'receiver']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_alert_groups" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='AlertGroups',  # noqa: E501
